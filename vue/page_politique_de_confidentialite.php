...
<div id="fond"> 
		<h1 class="cou1">Politique de confidentiqlité</h1>

		<p class="tiret">En devenant membre de ShareTime vous vous engagez à respecter toutes les conditions énumérées ci-dessous. ShareTime se réserve le droit de retirer sans avertissement, le profil de toute personne qui n'observe pas l'une des conditions suivantes.<br/>L'espace membre de ShareTime est uniquement accessible aux personnes de plus de 18 ans.<br/>Pour être Membre de ShareTime, vous devez être une personne physique, âgé(e) au minimum de 16 ans, avoir rempli l'ensemble des champs obligatoires figurant dans les formulaires d'inscription à ShareTime et avoir lu et accepté les présentes conditions d'utilisation lors de votre inscription. <br/>
...
•	Préférences (musicales, artistiques...)</br>
•	Situation familiale</br>
Les renseignements personnels que nous collectons sont recueillis au travers de formulaires et grâce à l'interactivité établie entre vous et notre site Web. Nous utilisons également, comme indiqué dans la section suivante, des fichiers témoins et/ou journaux pour réunir des informations vous concernant.</br>
...
•	Formulaire d'édition de vos informations personnelles</br>
