...
<html>
    ...
    <?php     echo '<p class="profil"> Pseudo : ' . htmlentities($_SESSION['pseudo']) .' <span class=\'modifier\'><a href="profil_v.php?modifier=1">Modifier</a></span><br/> Email : '.htmlentities($_SESSION['mail']).' <span class=\'modifier\'><a href="profil_v.php?modifier=2">Modifier</a></span><br/> Mot de passe : <span class=\'modifier\'><a href="profil_v.php?modifier=10">Modifier</a></span><br/> Nom : '. htmlentities($_SESSION['nom']) . ' <span class=\'modifier\'><a href="profil_v.php?modifier=3">Modifier</a></span><br/> Prénom : '.htmlentities($_SESSION['prenom']).'<span class=\'modifier\'><a href="profil_v.php?modifier=4">Modifier</a></span><br/> Date de naissance : ' . htmlentities($_SESSION['date_n']) .' <span class=\'modifier\'><a href="profil_v.php?modifier=5">Modifier</a></span></p>'; 
